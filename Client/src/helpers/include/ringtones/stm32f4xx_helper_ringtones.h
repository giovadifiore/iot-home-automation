/*
 * stm32f4xx_ringtones.h
 *
 *  Created on: 03/mag/2015
 *      Author: Ghost
 */

#ifndef _BUZZER_RINGTONES_H_
#define _BUZZER_RINGTONES_H_

#include "stm32f4xx_helpers.h"

/* Arduino Tone Library (in Hz) */
#define NOTE_B0  31
#define NOTE_C1  33
#define NOTE_CS1 35
#define NOTE_D1  37
...
void play_song(uint32_t);

#endif /* _BUZZER_RINGTONES_H_ */
